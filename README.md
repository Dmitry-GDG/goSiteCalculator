...
- Реализовано сохранение введённых и решённых выражений: после перезагрузки программы загруженные выражения не теряются, результыты вычислений не теряются, нерешённые выражения в приоритетном порядке отправляются на выполнение.
