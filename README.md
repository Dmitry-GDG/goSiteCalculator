...
- в терминал, в которм отправляются запросы, отправляется код страницы - сделано специально, это технический терминал
...
Подробнее об архитектуре приложения см ниже в разделе Архитектураприложения
